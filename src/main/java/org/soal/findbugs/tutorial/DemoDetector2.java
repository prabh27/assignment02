 ...
 */
public class DemoDetector2 implements Detector {
	 ...
	 */
	public DemoDetector2(BugReporter reporter) {
	...
	public void visitClassContext(ClassContext classContext) {
		...
		for (Method method : javaClass.getMethods()) {
			...
			if ("foo".equals(methodName) || "bar".equals(methodName)) {
				...
				BugInstance bug = new BugInstance("DEMO_BUG_2", Priorities.HIGH_PRIORITY)
